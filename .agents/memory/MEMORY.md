...
- [v0.3.2 fixes](v0.3.2-fixes.md) — city source-of-truth (never use stad/search query as city); balanced same-page fix; per-area budget ceiling; postal validation; 55 tests green.
